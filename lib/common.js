...
var common = module.exports = {
    ...
    accessTokenGenerationTimeInTimeStamp: -1,
    accessTokenExpireDurationInSeconds: -1,
    ...
    // todo? (bug: get instance throw error ...)
    getAccessToken: function(callback) {
        var timeSpentInSeconds = (common.accessTokenGenerationTimeInTimeStamp - (new Date().getTime())) / 1000;

        if (common.accessToken && (common.accessTokenExpireDurationInSeconds != -1 &&
           (timeSpentInSeconds < common.accessTokenExpireDurationInSeconds - 30))) {
                ...
                if (null == authInstanceId) {
                    ...
                    common.getMasterKey(function (masterKey) {
                        auth.loginMaster(authInstanceId, masterKey,{
                                success: function (accessToken, expireTimeInSeconds) {
                                    common.accessToken = accessToken;
                                    common.accessTokenGenerationTimeInTimeStamp = new Date().getTime();
                                    common.accessTokenExpireDurationInSeconds = expireTimeInSeconds;
