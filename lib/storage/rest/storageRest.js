        ...
        unirest.get(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    ...
                    sentry.warnLongAPICall("Get object from database", seconds_passed, url, "GET");
    ...
    filterObjects: function(accessToken, objectStorageInstanceId, collectionName,
        ...
        unirest.post(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall("Query objects from database", seconds_passed, url, "POST");
    ...
    save: function (accessToken, objectStorageInstanceId, url, json, options) {
        ...
        unirest.post(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall("Save object in database", seconds_passed, url, "POST");
    ...
    update: function (accessToken, objectStorageInstanceId, url, json, options) {
        ...
        unirest.put(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall("Update object in database", seconds_passed, url, "PUT");
    ...
    destroy: function (accessToken, objectStorageInstanceId, url, options) {
        ...
        unirest.delete(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success();
                    sentry.warnLongAPICall("Destroy object in database", seconds_passed, url, "DELETE");
    ...
    addOrRemoveRelation: function(accessToken, objectStorageInstanceId, url, key, action, relationList, options) {
        ...
        unirest.put(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall("Update object [add relation] in database", seconds_passed, url, "UPDATE");
