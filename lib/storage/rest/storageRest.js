        ...
        unirest.get(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    ...
                    sentry.warnLongAPICall(objectStorageInstanceId + " Get object", seconds_passed, url, "GET");
    ...
    filterObjects: function(accessToken, objectStorageInstanceId, collectionName,
        ...
        unirest.post(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall(objectStorageInstanceId + " Query " + collectionName, seconds_passed, url, "POST");
    ...
    save: function (accessToken, objectStorageInstanceId, url, json, options) {
        ...
        unirest.post(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall(objectStorageInstanceId + " Save object", seconds_passed, url, "POST");
    ...
    update: function (accessToken, objectStorageInstanceId, url, json, options) {
        ...
        unirest.put(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall(objectStorageInstanceId + " Update object", seconds_passed, url, "PUT");
    ...
    destroy: function (accessToken, objectStorageInstanceId, url, options) {
        ...
        unirest.delete(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success();
                    sentry.warnLongAPICall(objectStorageInstanceId + " Destroy object", seconds_passed, url, "DELETE");
    ...
    addOrRemoveRelation: function(accessToken, objectStorageInstanceId, url, key, action, relationList, options) {
        ...
        unirest.put(url)
            ...
            .end(function (response) {
                ...
                if (response.status == 200) {
                    options.success(response.body);
                    sentry.warnLongAPICall(objectStorageInstanceId + " Update object [add relation]", seconds_passed, url, "UPDATE");
