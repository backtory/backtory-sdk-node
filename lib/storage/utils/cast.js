...
var isPointer = function(model) {
    return (((typeof model)=="object") && "className" in model && "__type" in model && ((model["__type"] == "Pointer") || (model["__type"] == "Object")));
};

var isRelation = function(model) {
    return (model instanceof Array && model.length > 0 && isPointer(model[0]));
};

var isDate = function(model) {
    return (((typeof model)=="object") && "iso" in model && "__type" in model && (model["__type"] == "Date"));
};
