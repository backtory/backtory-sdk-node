...
connectivity.Match.sendPush = function (matchId, message, data, options) {
...
// PushBulk to match (as MasterMesasge)
connectivity.Match.prototype.addToPushBulk = function (matchId, message, data) {
    if ((typeof matchId != "string") || !(matchId)) {
        throw new Error("First argument (matchId) must be a valid string.");
    }
    else if ((typeof message != "object")) {
...
connectivity.Match.prototype.sendPushBulk = function (options) {
