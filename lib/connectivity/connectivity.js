...
var connectivity = module.exports = {
    ...
    OnlineUser: function OnlineUser() {
    },
...
connectivity.ChatMessage.prototype.sendFromUserToUser = function (senderUserId, receiverUserId, options) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.sendChatFromUserToUser(accessToken, connectivityInstanceId, senderUserId, receiverUserId, that.message, {
                    success: function () {
                        if (options && options.success) {
                            options.success();
                        }
...
connectivity.ChatMessage.prototype.sendFromUserToGroup = function (senderUserId, groupId, options) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.sendChatFromUserToGroup(accessToken, connectivityInstanceId, senderUserId, groupId, that.message, {
                    success: function () {
                        if (options && options.success) {
                            options.success();
                        }
...
connectivity.ChatGroup.create = function (options) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.createChatGroup(accessToken, connectivityInstanceId, that.name, that.type, that.ownerUserId, {
...
connectivity.ChatGroup.addMemberAsOwner = function (newMemberUserId, options) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.addMemberAsOwnerToChatGroup(accessToken, connectivityInstanceId, that.groupId, that.ownerUserId, newMemberUserId, {
                    success: function () {
                        if (options && options.success) {
                            options.success();
                        }
...
connectivity.ChatGroup.addMember = function (newMemberUserId, options) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.addMemberToChatGroup(accessToken, connectivityInstanceId, that.groupId, that.ownerUserId, newMemberUserId, {
                    success: function () {
                        if (options && options.success) {
                            options.success();
                        }
...
connectivity.ChatGroup.removeMember = function (toBeRemovedMemberUserId, options) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.removeMemberFromChatGroup(accessToken, connectivityInstanceId, that.groupId, that.ownerUserId, toBeRemovedMemberUserId, {
                    success: function () {
                        if (options && options.success) {
                            options.success();
                        }
...
connectivity.OnlineUser.prototype.checkUserStatus = function (userId, options) {
    if ((typeof userId != "string") || !(userId)) {
        throw new Error("First argument of 'OnlineUser.checkUserStatus' method (userId) must be a valid string.");
    }
...
connectivity.OnlineUser.prototype.checkUserListStatus = function (userIdList, options) {
    if (!(userIdList) || !(Array.isArray(userIdList)) || (userIdList.length == 0)) {
        throw new Error("First argument of method 'OnlineUser.checkUserListStatus' (userIdList) must be a valid non-empty Array.");
    }
...
// Note: this function is not documented
// Send direct chat message to a user as push (without sender)
connectivity.DirectChat.prototype.sendPush = function (message, receiverUserId, options) {
    if ((typeof message != "string") || !message) {
...
connectivity.GroupChat.prototype.sendPush = function (message, options) {
...
// Delete chat group
connectivity.GroupChat.prototype.deleteGroup = function (options) {
    var that = this;
    if (!that.groupId) {
        throw new Error("You must set 'groupId' of groupChat before calling 'GroupChat.sendAsPushToGroup' method.");
    }
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.deleteChatGroup(accessToken, connectivityInstanceId, that.groupId, {
                    success: function (groupId) {
                        if (options && options.success) {
                            that.groupId = groupId;
                            options.success(groupId);
...
connectivity.GroupChat.prototype.makeMemberOwner = function (newOwnerUserId, ownerUserId, options) {
    var that = this;
    if (!that.groupId) {
        throw new Error("You must set 'groupId' of groupChat before calling 'GroupChat.sendAsPushToGroup' method.");
    } else if ((typeof newOwnerUserId != "string") || !(newOwnerUserId)) {
        throw new Error("First argument (newOwnerUserId) of 'GroupChat.makeMemberOwner' method must be a valid string.");
    } else if ((typeof ownerUserId != "string") || !(ownerUserId)) {
        throw new Error("Second argument (ownerUserId) of 'GroupChat.makeMemberOwner' method must be a valid string.");
    }
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.addOwnerToChatGroup(accessToken, connectivityInstanceId, that.groupId, ownerUserId, newOwnerUserId, {
                    success: function () {
                        if (options && options.success) {
                            options.success();
                        }
...
connectivity.GroupChat.prototype.addMember = function (newMemberUserId, adderUserId, addAsOwner, options) {
    ...
    } else if (typeof addAsOwner != "boolean") {
        throw new Error("Third argument (addAsOwner) of 'GroupChat.addMember' method must be a valid boolean.");
    }
    if (!that.groupId) {
...
connectivity.RealtimeGame.prototype.sendServerMessageToUser = function (userId, message, data, options) {
...
connectivity.RealtimeGame.prototype.sendServerMessage = function (message, data, options) {
    ...
    if (typeof message === "string") {
        ...
        throw new Error("First argument (message) must be a valid string.");
    }
...
connectivity.RealtimeGame.prototype.addToEventBulk = function (matchId, userId, message, data) {
    if ((typeof matchId != "string") || !(matchId)) {
        throw new Error("First argument (matchId) must be a valid string.");
...
connectivity.RealtimeGame.prototype.sendWinners = function (winners, options) {
    this.sendWinners(winners, null, options);
};

connectivity.RealtimeGame.prototype.sendWinners = function (winners, extraData, options) {
    var matchId = this.matchId;
    if (!Array.isArray(winners)) {
        throw new Error("First argument of 'RealtimeGame.sendWinners' method (winners) must be a valid array.");
    }
    if (extraData !== null && typeof extraData !== "string") {
        throw new Error("Second argument of 'RealtimeGame.sendWinners' method (extraData) must be a valid string.");
    }
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.sendMatchResult(accessToken, connectivityInstanceId, matchId, winners, extraData, {
                    success: function (response) {
                        if (options && options.success) {
                            options.success(response);
                        }
...
// Get information of RealtimeGame
connectivity.RealtimeGame.prototype.getInfo = function (options) {
    var matchId = this.matchId;
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            error: function (error1) {
            ...
            success: function (accessToken) {
                connectivityRest.getMatchInfo(accessToken, connectivityInstanceId, matchId, {
                    success: function (response) {
                        if (options && options.success) {
                            options.success(response);
                        }
...
// add player to match
connectivity.RealtimeGame.prototype.addPlayer = function (userId, options) {
    var matchId = this.matchId;
    if ((typeof userId != "string") || !(userId)) {
    ...
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            ...
            success: function (accessToken) {
                connectivityRest.addPlayerToMatch(accessToken, connectivityInstanceId, matchId, userId, {
                    success: function (response) {
                        if (options && options.success) {
                            options.success(response);
                        }
...
// force start match
connectivity.RealtimeGame.prototype.start = function (options) {
    var matchId = this.matchId;
    connectivity.common.getInstance("realtime", function (connectivityInstanceId) {
        connectivity.common.getAccessToken({
            error: function (error1) {
            ...
            success: function (accessToken) {
                connectivityRest.startMatch(accessToken, connectivityInstanceId, matchId, {
                    success: function (response) {
                        if (options && options.success) {
                            options.success(response);
                        }
