...
var connectivity = module.exports = {
    ...
    RealtimeGame: function RealtimeGame(matchId) {
        if ((typeof matchId != "string") || !(matchId)) {
            throw new Error("First argument (matchId) of 'Match' constructor must be a valid string.");
        }
...
// ==============================================================================================
// =============================== Start of body of new functions ===============================

// --------------------------------------- Match functions --------------------------------------
// Push to single user (as MasterMessage)
...
connectivity.RealtimeGame.sendMasterPush = function (matchId, message, data, options) {
    if ((typeof matchId != "string") || !(matchId)) {
...
connectivity.RealtimeGame.prototype.addToMasterPushBulk = function (matchId, message, data) {
    if ((typeof matchId != "string") || !(matchId)) {
        throw new Error("First argument (matchId) must be a valid string.");
    }
    else if ((typeof message != "object")) {
...
connectivity.RealtimeGame.prototype.sendMasterPushBulk = function (options) {
...
connectivity.RealtimeGame.sendEventPush = function (matchId, userId, message, data, options) {
    if ((typeof matchId != "string") || !(matchId)) {
        throw new Error("First argument (matchId) must be a valid string.");
    }
...
connectivity.RealtimeGame.prototype.addToEventPushBulk = function (matchId, userId, message, data) {
    if ((typeof matchId != "string") || !(matchId)) {
        throw new Error("First argument (matchId) must be a valid string.");
    }
    else if ((typeof userId != "string") || !(userId)) {
...
connectivity.RealtimeGame.prototype.sendEventPushBulk = function (options) {
