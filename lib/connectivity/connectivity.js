...
connectivity.OnlineUsers.prototype.checkUserStatus = function (userId, options){
    var that = this;
...
connectivity.OnlineUsers.prototype.checkUsersStatus = function (userIds, options){
    var that = this;
