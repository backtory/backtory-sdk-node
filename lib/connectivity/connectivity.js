...
connectivity.ChatMessage.prototype.sendAsPushToUser = function (receiverUserId) {
    var that = this;
    ...
    connectivity.common.getInstance("connectivity", function (connectivityInstanceId) {
...
connectivity.ChatMessage.prototype.sendFromUserToUser = function (senderUserId, receiverUserId) {
    var that = this;
...
connectivity.ChatMessage.prototype.sendAsPushToGroup = function (groupId) {
    var that = this;
...
connectivity.ChatMessage.prototype.sendFromUserToGroup = function (senderUserId, groupId) {
    var that = this;
...
connectivity.ChatGroup.setName = function (groupName) {
    if ((typeof groupName != "string") || !(groupName)) {
        throw new Error("First argument (groupName) of 'setName' method must be a valid string.");
    }
    this.name = groupName;
};
...
connectivity.ChatGroup.setGroupId = function (groupId) {
    if ((typeof groupId != "string") || !(groupId)) {
        throw new Error("First argument (groupId) of 'setGroupId' method must be a valid string.");
    }
...
connectivity.ChatGroup.setOwnerUserId = function (ownerUserId) {
    if ((typeof ownerUserId != "string") || !(ownerUserId)) {
        throw new Error("First argument (ownerUserId) of 'setOwnerUserId' method must be a valid string.");
    }
...
connectivity.ChatGroup.setPrivate = function (isPrivate) {
    if ((typeof isPrivate != "boolean")) {
        throw new Error("First argument (isPrivate) of 'setPrivate' method must be a valid boolean.");
    }
    if (isPrivate)
        this.type = "Private";
    else
...
connectivity.ChatGroup.create = function (options) {
    var that = this;
    if (!that.name) {
        throw new Error("You must set 'groupName' of chatGroup before calling 'create' method.");
    } else if (!that.ownerUserId) {
        throw new Error("You must set 'ownerUserId' of chatGroup before calling 'create' method.");
    }
...
connectivity.ChatGroup.addOwner = function (newOwnerUserId, options) {
    ...
    if ((typeof newOwnerUserId != "string") || !(newOwnerUserId)) {
        throw new Error("First argument (newOwnerUserId) of 'addOwner' method must be a valid string.");
    } else if (!that.groupId) {
        throw new Error("You must set 'groupId' of chatGroup before calling 'addOwner' method.");
    } else if (!that.ownerUserId) {
        throw new Error("You must set 'ownerUserId' of chatGroup before calling 'addOwner' method.");
    }
...
connectivity.ChatGroup.addMember = function (newMemberUserId, options) {
    ...
    if ((typeof newMemberUserId != "string") || !(newMemberUserId)) {
        throw new Error("First argument (newMemberUserId) of 'addMember' method must be a valid string.");
    } else if (!that.groupId) {
        throw new Error("You must set 'groupId' of chatGroup before calling 'addMember' method.");
    } else if (!that.ownerUserId) {
        throw new Error("You must set 'ownerUserId' of chatGroup before calling 'addMember' method.");
    }
...
connectivity.ChatGroup.removeMember = function (toBeRemovedMemberUserId, options) {
    ...
    if ((typeof toBeRemovedMemberUserId != "string") || !(toBeRemovedMemberUserId)) {
        throw new Error("First argument (toBeRemovedMemberUserId) of 'removeMember' method must be a valid string.");
    } else if (!that.groupId) {
        throw new Error("You must set 'groupId' of chatGroup before calling 'removeMember' method.");
    } else if (!that.ownerUserId) {
        throw new Error("You must set 'ownerUserId' of chatGroup before calling 'removeMember' method.");
    }
