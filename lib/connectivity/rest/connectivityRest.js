...
var rest = module.exports = {
    ...
    sendPush: function(accessToken, connectivityInstanceId, matchId, message, data, options) {
        var old_time = new Date();
    ...
    sendPushBulk: function(accessToken, connectivityInstanceId, bulk, options) {
        var old_time = new Date();
    ...
    sendEventPush: function(accessToken, connectivityInstanceId, bulk, options) {
        var old_time = new Date();
